...
naka = asteroid[((asteroid.peri<5.2) & (asteroid.e>0.75) & (asteroid.a>8)) | (asteroid.i>90)]
gibson = asteroid[(asteroid.aph>50) & (asteroid.e>0.9)]
tancredi = asteroid[(asteroid.tiss<2) & (asteroid.a>30.1)]
...
print('Number of Nakamura damocloids detected = ', len(naka))
print('Number of Tancredi damocloids detected = ', len(tancredi))
